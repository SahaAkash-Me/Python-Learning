...
# │  ├── 4.1  Numeric Aggregations  →  max / min / sum / len                    │
# │  ├── 4.2  Completeness Check   →  all() / any()                             │
# │  ├── 4.3  Search & Count       →  .count() / .index()                       │
...
# │  ├── 5.1  Adding    →  .append() / .insert()                                │
# │  ├── 5.2  Removing  →  .remove() / .pop() / .clear()                        │
# │  └── 5.3  Updating  →  index assignment                                     │
# │                                                                             │
# │  SECTION 6 — SORTING                                                        │
# │  ├── 6.1  .sort()     →  Sorts in place (modifies original)                 │
# │  ├── 6.2   sorted()    →  Returns new sorted list (keeps original)          │
